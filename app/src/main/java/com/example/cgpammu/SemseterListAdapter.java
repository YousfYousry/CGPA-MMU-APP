...
public class SemseterListAdapter extends ArrayAdapter<MarksForDegree> {
     ...
     * @param objects
     */
    public SemseterListAdapter(Context context, int resource, ArrayList<MarksForDegree> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(colors[position]==0){
            ...
            convertView.setBackgroundColor(Color.rgb(120,120,120));
            ...
            convertView.setBackgroundColor(Color.rgb(11,131,194));
            holder.code.setTextSize(20);
            holder.name.setTextSize(20);
            holder.hours.setTextSize(20);
            holder.TitleHolder.setTextSize(20);
